...
describe('DataTable.vue', () => {
  ...
  //   })
    ...
    it('should exist just one sort arrow when onlyShowOrderedArrow is true', () => {
      const wrapper = mount(DataTable, { propsData: mock.onlyShowOrderedArrow })
      const ths = wrapper.findAll('.v-datatable-light thead tr th')
      expect(ths).toHaveLength(4)

      const arrow1 = ths.at(0).findAll('.th-wrapper .arrows-wrapper .arrow')
      ...
      console.log('QQQQQQQQQQQQQq', arrow2Wrapper.at(0).html());
      const arrow2 = arrow2Wrapper.at(0).findAll('.arrow-up')
      expect(arrow2).toHaveLength(1)
      // console.log('QQQQQQQQQQQQQq', arrow2.html());
