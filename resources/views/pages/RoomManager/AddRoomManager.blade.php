...
<div id="root-title">
    <page-title>Add Room</page-title>
</div>
    ...
    <div class="row justify-content-center align-self-center">
        <div class="col-7">
        	...
        	<div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{url('/save-new-room')}}" method="post" enctype="multipart/form-data">
              	{{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                    <label for="room_name">Room Name</label>
                    <input type="text" class="form-control" id="room_name" name="room_name" placeholder="" value="{{ ( Session::get('room_name') ? Session::get('room_name') : '') }}">
